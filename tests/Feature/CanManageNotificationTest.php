...
class CanManageNotificationTest extends TestCase
{
    ...
    function guest_users_cannot_mark_notifications()
    {
    ...
    function authenticated_users_can_mark_notifications_as_read()
    {
        $this->withoutExceptionHandling();

        $user = factory(User::class)->create();

        $notification = factory(DatabaseNotification::class)->create(['notifiable_id' => $user->id, 'read_at' => null]);
    ...
    function authenticated_users_can_mark_notifications_as_unread()
    {
        $this->withoutExceptionHandling();

        $user = factory(User::class)->create();

        $notification = factory(DatabaseNotification::class)->create(['notifiable_id' => $user->id, 'read_at' => now()]);
